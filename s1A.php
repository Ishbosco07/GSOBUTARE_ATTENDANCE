...
<body>
    ...
    <h2>List of students in Senior one</h2>
...
<table style="background-color:white">
    <th>
        ...
        <?php
         ...
         $sql="SELECT * FROM students WHERE class='S1';";
         $result=mysqli_query($conn,$sql);
         $resultCheck=mysqli_num_rows($result);

         if($resultCheck<1)
         {
             echo 'No S1 students registered!';
         }
         elseif($resultCheck>0)
         {
            ...
            while($row=mysqli_fetch_assoc($result))
            {
                ...
                echo '<td><input type="checkbox" name="present[]" style="width:20px"></td>';
